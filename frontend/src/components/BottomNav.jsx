  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-slate-200 flex justify-around items-center h-16 z-40 pb-safe shadow-[0_-5px_15px_rgba(0,0,0,0.05)]">
      ...
      <Link 
        ...
        className={`flex flex-col items-center justify-center w-full h-full space-y-1 transition-colors ${isActive('/') ? 'text-green-600' : 'text-slate-500 hover:text-green-500'}`}
      >
     ...
     <Link 
        to="/wishlist" 
        onClick={handleScrollToTop} 
        className={`flex flex-col items-center justify-center w-full h-full space-y-1 relative transition-colors ${isActive('/wishlist') ? 'text-red-500' : 'text-slate-500 hover:text-red-500'}`}
      >
     ...
     <Link 
        to="/cart" 
        onClick={handleScrollToTop} 
        className={`flex flex-col items-center justify-center w-full h-full space-y-1 relative transition-colors ${isActive('/cart') ? 'text-green-600' : 'text-slate-500 hover:text-green-500'}`}
      >
        <div className="relative">
      ...
      <Link 
        ...
        onClick={handleScrollToTop} 
        className={`flex flex-col items-center justify-center w-full h-full space-y-1 transition-colors ${isActive('/profile') || isActive('/login') ? 'text-green-600' : 'text-slate-500 hover:text-green-500'}`}
      >
